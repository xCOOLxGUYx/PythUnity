...
setup(
  ...
  version = '0.83',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/xCOOLxGUYx/PythUnity/archive/v_08_3.tar.gz',    # I explain this later on
